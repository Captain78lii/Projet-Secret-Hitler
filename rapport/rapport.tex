...
\subsubsection{Condition Spéciale : Hitler Chancelier}
Il existe une condition de victoire alternative et immédiate pour les Fascistes : si \textbf{Hitler est élu Chancelier} après que 3 lois fascistes ont déjà été votées, la partie s'arrête instantanément.

Pour marquer ce scénario dramatique, le jeu génère un article de journal annonçant la chute de la République :
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        \caption{Journal annonçant l'élection d'Hitler}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{image_578b28.png}
        \caption{Article : "Tragédie Nationale"}
    \end{minipage}
\end{figure}
